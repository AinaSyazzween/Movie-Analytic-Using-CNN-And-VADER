...
UPLOAD_FOLDER = r'C:\Users\User\Documents\Aina\Sourcecode\static\img'
...
def api():
    ...
    if file and allowed_file(file.filename):
        ...
        model = keras.models.load_model("C:/Users/user/Aina/Sourcecode/model/PosterCNN.h5")
        ...
        top3 = [classes[y_prob.index(sorted_y[i])] for i in range(4)]
        return render_template("classification.html",
